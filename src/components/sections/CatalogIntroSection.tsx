      ...
      <div className="w-full relative" style={{ maxWidth: 'var(--max-width)' }}>
        ...
        >
          ...
          >
            ...
            Inspired by the iconic music libraries of the past (KPM, DeWolfe, Chappell), we've built a custom catalog of original instrumentals, when more sophisticated library music is needed. KPM. DeWolfe. Chappell. Inspired by the music libraries of yesteryear, we've crafted thematic albums from our private collection where-ever unusual library music is needed.
            </p>
          </div>
        </div>
      </div>
